...
export const FounderGridLogo: React.FC<FounderGridLogoProps> = ({
  ...
  // Tagline letterspacing and size are calibrated to match the title width perfectly
  ...
  // The 4-Quadrant Emblem Mark
  // With withContainer=false, viewBox="18 16 164 166" fits the 160x162 geometry with zero blank outer margins!
  const EmblemMark = (
    <svg
    ...
    >
      ...
      {/* Optional squircle backdrop tile like App Icon */}
      {withContainer && (
        <rect
          x="0"
          y="0"
      ...
      <g transform={withContainer ? 'translate(22, 22) scale(0.78)' : undefined}>
        ...
        {/* Bottom-Right Arched Quadrant (with subtle graphite dimension) */}
        <path
